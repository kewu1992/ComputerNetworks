...
OBJS		= peer.o bt_parse.o spiffy.o debug.o input_buffer.o chunk.o sha.o helper.o whohas_ihave.o pkt_helper.o ack.o connection.o data.o denied.o get.o timeout.o
